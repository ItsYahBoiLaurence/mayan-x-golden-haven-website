jQuery(document).ready(function ($) {
    ...
    jQuery('.per_listing_payment').click(function(event){
      ...
      console.log('#paymodal_'+post_id)
      jQuery('#paymodal_'+post_id).show();
      //jQuery('#payment_backgorund_'+post_id).show();
    });
    ...
    $('.disable_listing').on( 'click', function(event) {
      ...
      var ajaxurl     =   wpestate_dashboard_js_vars.ajaxurl + '/admin-ajax.php';
      var is_disabled =   0;
         ...
         '<div id="upload-container">'+
           '<div id="aaiu-upload-container">'+
              ...
              '<div id="imagelist">'+
                  ...
                  '<input type="hidden" name="plan_image_attach[]" value="">'+
               '</div>'+
