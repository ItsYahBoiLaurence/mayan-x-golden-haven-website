...
if( $user_dashboard_content_button_back    !=''){
    ...
    .wpestate_dashboard_content_wrapper .wpresidence_button{
        background-color: ' . $user_dashboard_content_button_back  . '!important;
    }
...
if( $user_dashboard_content_color    !=''){
    print'.wpestate_dashboard_table_list_header, .wpestate_dashboard_content_wrapper label,.dashboard-margin .entry-title,.user_details_row, .change_pass,.user_details_row, .change_pass,.user_profile_explain, .profile-page label, .pass_note, .upload_explain, .full_form_image,.invoice_totals,.invoice_unit_title,.invoice_unit,.col-md-12.row_dasboard-prop-listing h4 { color: ' . $user_dashboard_content_color . ';}';
}
