...
$user_custom_picture    =   wp_get_attachment_image_src(get_post_thumbnail_id($listing_edit), 'user_picture_profile');
...
$agent_information_fields=array(
  ...
  //                 'label' =>  esc_html__('Agent Username','wpresidence').esc_html__('is not editable','wpresidence'),
  //                  'meta' =>  'first_name',
  //                  'type' =>  'user_meta',
  //                  'bootstral_length'=>12,
  //               ),
