...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MDVF4DZ"
...
<div id="post" <?php post_class('row');?>>
    ...
    <div class=" <?php print esc_html($wpestate_options['content_class']);?> single_width_blog">
       ...
       <div class="prop_social_single">
                			...
                			<a href="https://www.facebook.com/sharer.php?u=<?php the_permalink(); ?>&amp;t=<?php echo urlencode(get_the_title()); ?>" target="_blank" class="share_facebook" style="font-size: 20px;"><i class="fab fa-facebook-f"></i></a>
                			<a href="https://twitter.com/intent/tweet?text=<?php echo urlencode(get_the_title() .' '.  esc_url( get_permalink() )); ?>" class="share_tweet" target="_blank" style="font-size: 20px;"><i class="fab fa-twitter"></i></a>
                <?php if (isset($pinterest[0])){ ?>
                   			<a href="https://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&amp;media=<?php echo esc_url($pinterest[0]);?>&amp;description=<?php echo urlencode(get_the_title()); ?>" target="_blank" class="share_pinterest" style="font-size: 20px;"> <i class="fab fa-pinterest-p"></i> </a>      
                <?php } ?>
                   			 <a href="https://api.whatsapp.com/send?text=<?php echo urlencode( get_the_title().' '. esc_url( get_permalink() )); ?>" class="" style="font-size: 20px;"><i class="fab fa-whatsapp" aria-hidden="true"></i></a>   
       
                			<a href="mailto:email@email.com?<?php echo trim(esc_html($email_link));?>"  class="social_email" style="font-size: 20px;"> <i class="far fa-envelope"></i></a>
