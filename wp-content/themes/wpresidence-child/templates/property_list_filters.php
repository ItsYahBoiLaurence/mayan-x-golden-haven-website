   ...
   // county / state fielter
    ...
    if(isset($current_adv_filter_county[0])){
        if($current_adv_filter_county[0]=='all'){
            $current_adv_filter_county_label      ='Region';
            // $current_adv_filter_county_label      =esc_html__('States','wpresidence');
            $current_adv_filter_county_meta       = 'Region';
            // $current_adv_filter_county_meta       = 'States';
        }else{
    ...
    if($current_adv_filter_area[0]=='all'){
        $current_adv_filter_area_label      = /*esc_html__('Areas','wpresidence')*/'Provinces';
        $current_adv_filter_area_meta       = /*'Areas'*/'Provinces';
        // $current_adv_filter_area_meta       = 'Areas';
    }else{
    ...
    <div class="listing_filters_head"> 
        <input type="hidden" id="page_idx" value="<?php 
                ...
                <div class="dropdown listing_filter_select filter_county" >
                  <div data-toggle="dropdown" id="a_filter_county" class="filter_menu_trigger" data-value="<?php print esc_attr($current_adv_filter_county_meta);?>"> Region<?php //print esc_html($current_adv_filter_county_label);?> <span class="caret caret_filter"></span> </div>           
                ...
                <div class="dropdown listing_filter_select filter_area" >
                  <div data-toggle="dropdown" id="a_filter_areas" class="filter_menu_trigger" data-value="<?php print esc_attr($current_adv_filter_area_meta);?>">Provinces<?php //print esc_html($current_adv_filter_area_label);?><span class="caret caret_filter"></span> </div>           
