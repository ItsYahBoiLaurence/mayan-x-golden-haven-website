...
function estate_listing_address($post_id,$wpestate_prop_all_details='',$columns=''){
    ...
    if ($property_area != ''){
        $return_string.= '<div class="listing_detail col-md-'.$colmd.'"><strong>'.esc_html__('Province','wpresidence').':</strong> ' .$property_area. '</div>';
        // $return_string.= '<div class="listing_detail col-md-'.$colmd.'"><strong>'.esc_html__('Area','wpresidence').':</strong> ' .$property_area. '</div>';
    }    
    if ($property_county != ''){
        $return_string.= '<div class="listing_detail col-md-'.$colmd.'"><strong>'.esc_html__('Region','wpresidence').':</strong> ' . $property_county . '</div>'; 
